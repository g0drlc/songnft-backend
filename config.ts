...
export const config = {
  ...
  SOLANA_PRIVATE:
    "2k3rfWSwr1DjL6EYFzS9hYSaZLxuJdBYRYomkJQ2XXU6u2tbmBNP7mdCW2GJK76GQzxmr1zkUubaj5VhKF1bSiPC", // BE Sol Vault wallet privatekey
  ...
  SOL_TOKEN_DECIMAL: 0, // SOL Token decimal
